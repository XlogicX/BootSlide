...
; This is a routine for displaying all of the tiles
  ...
  displaytilesloop:
    mov ah, 0x30          ; Black on light-blue background
...
; Color 1
mov di, dx
mov ax, 0x13b1                        ; shaded corner border
mov bx, 5                             ; rows
mov word [rectrow + 1], 7             ; columns
mov word [nextline + 2], 160 - (7*2)  ; put column number before '*2'
call drawrect
; Color 2
mov di, dx
mov ah, 0x33                          ; inner light blue main part of tile
mov bx, 4                             ; rows
...
ordered:
dw 0x4321, 0x8765, 0xcba9, 0x0fed
